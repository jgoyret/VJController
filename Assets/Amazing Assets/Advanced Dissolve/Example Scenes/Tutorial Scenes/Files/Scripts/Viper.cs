...
namespace AmazingAssets.AdvancedDissolve.ExampleScripts
{
    public class Viper : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            AmazingAssets.AdvancedDissolve.AdvancedDissolveProperties.Edge.Base.UpdateLocalProperty(material, AdvancedDissolveProperties.Edge.Base.Property.ColorIntensity, Random.Range(14f, 17f));

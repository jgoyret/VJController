...
namespace AmazingAssets.AdvancedDissolve.ExampleScripts
{
    public class AnimateCutoutAndDestroy : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //Randomize intensity
            AmazingAssets.AdvancedDissolve.AdvancedDissolveProperties.Edge.Base.UpdateLocalProperty(material, AdvancedDissolveProperties.Edge.Base.Property.ColorIntensity, Random.Range(13f, 17f));
